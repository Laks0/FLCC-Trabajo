\subsection*{Ejercicio 15: dar un circuito que genere el estado $\frac{1}{\sqrt{2}}|000\rangle + \frac{1}{\sqrt{2}}|111\rangle$ a partir de la entrada $|000\rangle$}
...
Al analizar la traza se ve que, comenzando con la entrada \ket{000} se obtiene el estado deseado.
