...
$\pi$ es el operador de medición a bits clásicos también dado en el paper.

El término para el algoritmo es:
...
\subsubsection*{Derivación para $b_1 = \text{inr}(1.\star), b_2 = \text{inr}(1.\star)$.}
\[
